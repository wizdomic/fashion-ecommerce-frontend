...
import { LinearProgress, Box, Grid2 } from "@mui/material";
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Typography component="legend">5.5</Typography>
                  <p className="opacity-60 text-sm">56540 Rating</p>
            ...
            <Grid2 container spacing={7}>
              ...
              <Grid2 item xs={5}>
                ...
                <div className="flex items-center space-x-3 ">
                  ...
                  <p className="opacity-60">59485 Ratings</p>
                </div>
              </Grid2>
            </Grid2>
          </div>
